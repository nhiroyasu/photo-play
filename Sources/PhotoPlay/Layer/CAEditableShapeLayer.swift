...
class CAEditableShapeLayer: CAShapeLayer, EditableLayer {
    public let id: UUID
    ...
    public override init(layer: Any) {
        if let editableShapeLayer = layer as? CAEditableShapeLayer {
            ...
            assertionFailure("Only CAEditableShapeLayer can be added.")
            self.id = UUID()
